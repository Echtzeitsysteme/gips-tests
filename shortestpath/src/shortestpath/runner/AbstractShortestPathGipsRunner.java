...
public abstract class AbstractShortestPathGipsRunner {
	 ...
	 */
	protected void gipsSave(final ShortestpathGipsAPI gipsApi, final String path) {
		try {
	 ...
	 * given shortest path GIPS API object.
	 * 
	 * @param gipsApi Shortest path GIPS API object to get all mapping information
	 *                from.
	 */
